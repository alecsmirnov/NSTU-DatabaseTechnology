...
CREATE TABLE j (n_izd varchar(6) NOT NULL,
                name varchar(20),
                town varchar(20));
...
CREATE TABLE p (n_det varchar(6) NOT NULL,
                name varchar(20),
                cvet varchar(20),
                ves integer,
                town varchar(20));
...
CREATE TABLE s (n_post varchar(6) NOT NULL,
                name varchar(20),
                reiting integer,
                town varchar(20));
...
-- ТАБЛИЦА spj – Поставки (Supply)

CREATE TABLE spj (n_spj varchar(6) NOT NULL,
                  n_post varchar(6) NOT NULL,
                  n_det varchar(6) NOT NULL,
                  n_izd varchar(6) NOT NULL,
                  kol integer,
                  date_post date NOT NULL,
                  cost integer NOT NULL
                  CONSTRAINT poscost CHECK (cost > 0),
                  CONSTRAINT poskol CHECK (kol > 0));
ALTER TABLE ONLY spj ADD CONSTRAINT spj_n_post_key UNIQUE (n_post, n_det, n_izd, date_post);
ALTER TABLE ONLY spj ADD CONSTRAINT spj_pkey PRIMARY KEY (n_spj);
COMMENT ON TABLE spj IS 'Поставки';
COMMENT ON COLUMN spj.n_spj IS 'номер поставки';
COMMENT ON COLUMN spj.n_post IS 'номер поставщика';
COMMENT ON COLUMN spj.n_det IS 'номер детали';
COMMENT ON COLUMN spj.n_izd IS 'номер изделия';
COMMENT ON COLUMN spj.kol IS 'количество деталей';
COMMENT ON COLUMN spj.date_post IS 'дата поставки';
COMMENT ON COLUMN spj.cost IS 'цена за одну деталь';

-- ТАБЛИЦА c – Заказчики (Client)

CREATE TABLE c (n_cl varchar(6) NOT NULL,
                name varchar(20),
                town varchar(10),
                discount integer);
...
CREATE TABLE q (n_q varchar(6) NOT NULL,
                n_izd varchar(6) NOT NULL,
                n_det varchar(6) NOT NULL,
...
CREATE TABLE w (n_part varchar(6) NOT NULL,
                n_izd varchar(6) NOT NULL,
                date_part date,
                kol integer NOT NULL);
...
CREATE TABLE e (n_exp varchar(6) NOT NULL,
                n_izd varchar(6) NOT NULL,
...
CREATE TABLE v (n_v varchar(6) NOT NULL,
                n_izd varchar(6) NOT NULL,
                date_begin date NOT NULL,
                cost integer NOT NULL);
ALTER TABLE ONLY v ADD CONSTRAINT n_n_izd_key UNIQUE (n_izd, date_begin);
...
CREATE TABLE r (n_real varchar(10) NOT NULL,
                n_izd varchar(6) NOT NULL,
                n_cl varchar(6) NOT NULL,
...
-- ТАБЛИЦА spj – Поставки (Supply)
INSERT INTO spj (n_spj, n_post, n_det, n_izd, kol, date_post, cost)
...
-- ТАБЛИЦА q – Норма расхода деталей на одно изделие
INSERT INTO q (n_izd, n_det, kol, n_q) 
VALUES ('J4','P5',2,'Q1'),
       ('J4','P2',1,'Q2'),
       ('J4','P6',2,'Q3'),
       ('J5','P3',4,'Q4'),
...
INSERT INTO e VALUES 
    ('E1','J1',to_date('2011-01-01','YYYY-MM-DD'),80),
...
VALUES ('R1','J1','C1',to_date('10-02-2011','dd-mm-yyyy'),to_date('13-02-2011','dd-mm-yyyy'),to_date('03-03-2011','dd-mm-yyyy'),15,275),
       ('R2','J6','C2',to_date('01-03-2011','dd-mm-yyyy'),to_date('06-03-2011','dd-mm-yyyy'),to_date('13-03-2011','dd-mm-yyyy'),30,300),
       ('R3','J1','C3',to_date('05-03-2011','dd-mm-yyyy'),to_date('07-03-2011','dd-mm-yyyy'),to_date('10-03-2011','dd-mm-yyyy'),30,280),
       ('R4','J3','C2',to_date('03-04-2011','dd-mm-yyyy'),to_date('07-04-2011','dd-mm-yyyy'),to_date('09-04-2011','dd-mm-yyyy'),25,300),
       ('R5','J2','C5',to_date('22-04-2011','dd-mm-yyyy'),to_date('24-04-2011','dd-mm-yyyy'),to_date('26-04-2011','dd-mm-yyyy'),15,400),
       ('R6','J7','C5',to_date('08-05-2011','dd-mm-yyyy'),to_date('11-05-2011','dd-mm-yyyy'),to_date('13-05-2011','dd-mm-yyyy'),70,325),
       ('R7','J5','C2',to_date('15-05-2011','dd-mm-yyyy'),to_date('19-05-2011','dd-mm-yyyy'),to_date('22-05-2011','dd-mm-yyyy'),40,290),
       ('R8','J3','C4',to_date('20-05-2011','dd-mm-yyyy'),to_date('23-05-2011','dd-mm-yyyy'),to_date('24-05-2011','dd-mm-yyyy'),15,290),
       ('R9','J1','C6',to_date('09-06-2011','dd-mm-yyyy'),to_date('15-06-2011','dd-mm-yyyy'),to_date('20-06-2011','dd-mm-yyyy'),45,285),
       ('R10','J6','C2',to_date('15-06-2011','dd-mm-yyyy'),to_date('16-06-2011','dd-mm-yyyy'),to_date('16-06-2011','dd-mm-yyyy'),20,300),
       ('R11','J4','C3',to_date('19-06-2011','dd-mm-yyyy'),to_date('27-06-2011','dd-mm-yyyy'),to_date('27-06-2011','dd-mm-yyyy'),30,445),
       ('R12','J1','C5',to_date('01-07-2011','dd-mm-yyyy'),to_date('03-07-2011','dd-mm-yyyy'),to_date('05-07-2011','dd-mm-yyyy'),50,277),
       ('R13','J5','C1',to_date('01-09-2011','dd-mm-yyyy'),to_date('04-09-2011','dd-mm-yyyy'),to_date('04-09-2011','dd-mm-yyyy'),100,285),
       ('R14','J4','C4',to_date('20-09-2011','dd-mm-yyyy'),to_date('21-09-2011','dd-mm-yyyy'),to_date('21-09-2011','dd-mm-yyyy'),120,420),
       ('R15','J3','C2',to_date('20-10-2011','dd-mm-yyyy'),to_date('23-10-2011','dd-mm-yyyy'),to_date('24-10-2011','dd-mm-yyyy'),25,295),
       ('R16','J7','C6',to_date('01-11-2011','dd-mm-yyyy'),to_date('03-11-2011','dd-mm-yyyy'),to_date('06-11-2011','dd-mm-yyyy'),80,415),
       ('R17','J1','C1',to_date('11-01-2012','dd-mm-yyyy'),to_date('13-01-2012','dd-mm-yyyy'),to_date('15-01-2012','dd-mm-yyyy'),10,280),
       ('R18','J6','C2',to_date('15-04-2012','dd-mm-yyyy'),to_date('22-04-2012','dd-mm-yyyy'),to_date('23-04-2012','dd-mm-yyyy'),60,350),
       ('R19','J4','C6',to_date('13-05-2012','dd-mm-yyyy'),to_date('15-05-2012','dd-mm-yyyy'),to_date('20-05-2012','dd-mm-yyyy'),50,500),
       ('R20','J2','C6',to_date('01-06-2012','dd-mm-yyyy'),to_date('05-06-2012','dd-mm-yyyy'),null,30,490),
       ('R21','J7','C2',to_date('20-06-2012','dd-mm-yyyy'),to_date('21-06-2012','dd-mm-yyyy'),to_date('25-06-2012','dd-mm-yyyy'),150,415),
       ('R22','J3','C4',to_date('10-08-2012','dd-mm-yyyy'),to_date('12-08-2012','dd-mm-yyyy'),to_date('13-08-2012','dd-mm-yyyy'),60,330),
       ('R23','J5','C3',to_date('15-08-2012','dd-mm-yyyy'),to_date('19-08-2012','dd-mm-yyyy'),to_date('21-08-2012','dd-mm-yyyy'),120,350),
       ('R24','J4','C3',to_date('20-08-2012','dd-mm-yyyy'),null,null,70,520),
       ('R25','J3','C2',to_date('20-08-2012','dd-mm-yyyy'),to_date('22-08-2012','dd-mm-yyyy'),to_date('26-08-2012','dd-mm-yyyy'),45,340),
       ('R26','J1','C3',to_date('25-08-2012','dd-mm-yyyy'),to_date('27-08-2012','dd-mm-yyyy'),null,50,290),
       ('R27','J6','C2',to_date('15-09-2012','dd-mm-yyyy'),to_date('17-09-2012','dd-mm-yyyy'),null,70,350);
...
SELECT posts.year, posts.n_izd, posts.name, COALESCE(info.max_post, 0) AS max_post, COALESCE(info.total_sum_post, 0) AS total_sum, COALESCE(info.percent, 0) AS percent
FROM (SELECT years.year, izds.n_izd, izds.name
      FROM (SELECT DISTINCT EXTRACT(year FROM spj.date_post) AS year 
            FROM spj
           ) years
      CROSS JOIN (SELECT j.n_izd, j.name
                  FROM j
                 ) izds
     ) posts
LEFT JOIN (SELECT izd.year, izd.n_izd, izd.max_post, izd.total_sum_post, ROUND(izd.total_sum_post * 100 / total.sum::numeric, 2) AS percent
