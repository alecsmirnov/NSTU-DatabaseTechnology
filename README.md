...
| :---------------:| :------------------:|:-------------------:|
| Однонаправленное тиражирование<br> «Центр-филиалы»<p align="center"> <img width="200" src="course-replication-scheme.png"> </p> Изменение (вставка, модификация, удаление),<br> выполненное в одной из периферийных баз данных (ПБД), тиражируется в центральную базу данных (ЦБД) | После выполнения указанного числа транзакций, задаваемого при запуске программы РД | В пользу более позднего обновления |
